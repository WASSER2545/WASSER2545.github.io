...
{% include figure.html path="assets/img/blog/future-database-architecture.png" class="img-fluid w-75 d-block mx-auto" alt="Architecture of a user-aware, data-optional database that generates expectation-aligned answers and backfills supporting evidence" caption="Reference architecture for a data-optional, user-aligned database. Ground truth is retained as an optional storage primitive." zoomable=true %}
